...
public class FunctionEx {
	public static void main(String[] args) {
		...
		// UpperCaseName()).collect(Collectors.toList());//metodo interface

		// List<String>names =list.stream().map(ProductFunction
		// ::staticUpperCase).collect(Collectors.toList());// metodo estatico
